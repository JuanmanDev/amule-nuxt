    ...
    AMuleCli.prototype.readValueOfANode = function (child2, buffer) {
        ...
        if (child2.typeEcOp === this.ECOpCodes.EC_TAGTYPE_UINT8) {
            ...
            if (!this.textDecoder && typeof this.stringDecoder === 'undefined') {
                console.log("you won't be able to read special utf-8 char, textDecoder: ", this.textDecoder, " stringDecoder: ", this.stringDecoder);
            }
            var uint8array = [];
...
module.exports = { AMuleCli: AMuleCli };
